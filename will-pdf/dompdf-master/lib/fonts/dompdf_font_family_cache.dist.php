...
return function ($rootDir) {
    ...
    return [
        ...
        'avenirlight' => array(
                'normal' => $distFontDir . '/AvenirLTStd-Light',
                'bold' => $distFontDir . '/AvenirLTStd-Light',
                'italic' => $distFontDir . '/AvenirLTStd-Light',
                'bold_italic' => $distFontDir . '/AvenirLTStd-Light',
              ),
        'avenirmedium' => array(
        'normal' => $distFontDir . '/AvenirLTStd-Medium',
        'bold' => $distFontDir . '/AvenirLTStd-Medium',
        'italic' => $distFontDir . '/AvenirLTStd-Medium',
        'bold_italic' => $distFontDir . '/AvenirLTStd-Medium',
        ),
    ];
};
