...
if (is_user_logged_in() || !empty($will_id)) :
    $html .= '<div class="pdf-content">
        ...
        <div>
                ...
                $html .= '</ol>
                            ...
                            <li>
                                ...
                                if (!empty($will_data['sec8']['positions'])): 
                                    ...
                                    if (!empty($will_data['sec9']['specificsDetails'])) {
                                        foreach ($will_data['sec9']['specificsDetails'] as $key => $value) {
                                ...
                                <?php if (!empty($Property)):
                                    ...
                                    foreach ($Property as $key => $value): 
                                        $html .= '<li>
                                            ...
                                            <ol type="i">
                                                <li><p>'.  $i .' Property - Situate At '. $will_data['sec8']['positions'][$value]['address'].', In The Parish Of '. $will_data['sec8']['positions'][$value]['parish'] .'Registered At '. $will_data['sec8']['positions'][$value]['registeredAt'].' Of The Register Book Of Titles To '. $will_data['sec9']['specificsDetails'][$value]['giftBenefIndex'].'.</p></li>
                                            </ol>
                                        </li>';
                                      $i++; 
                                    endforeach;
            ...
            <div style="margin-top:40px;">
                ...
                $image_name = $username.'.png';
                 ...
                 $sign_data = file_get_contents($image_path);
                if (($sign_data)) {
                    $html .='<img width="150px" src="'.$image_path.'" alt="' . esc_attr($username) . ' signature">';
                } else {
                    $html .= '<div class="mb-2">
                        <h5>Signature Pad</h5>
                        <div class="row">
        ...
        ?>
        <a href="<?php echo home_url('/download-signed-will/') ?>" target="_blank" class="">Download Signed PDF</a>
...
<script>
    jQuery(document).ready(function($) {
        ...
        document.getElementById('save').addEventListener('click', () => {
            ...
            formData.append('_ajax_nonce', '<?php echo wp_create_nonce("save_signature_nonce"); ?>');
