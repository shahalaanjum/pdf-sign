...
function populateCountries(countryElementId, stateElementId){
	...
	if( stateElementId ){
		...
		setTimeout(()=>{
			prePopulateStates( countryElementId, stateElementId );
		},2000)
	}
}
function prePopulateStates( countryElementId, stateElementId ){
	...
	var prePopulatedState = document.querySelector('#prePopulatedState').value	
	if(prePopulatedState) stateElement.value = prePopulatedState;
}